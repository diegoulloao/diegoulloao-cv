...
<form id="contact-form" class="w-full max-w-xl mx-auto mt-14 sm:mt-20">
  ...
  <div class="md:flex items-center">
    <div class="w-full flex flex-col">
      ...
      <input
        ...
        class="leading-none text-gray-50 p-3 focus:outline-none mt-3 sm:mt-4 bg-black border caret-purple"
        data-1p-ignore
      />
    </div>
  </div>
  ...
  <div class="w-full flex flex-col mt-6 sm:mt-8">
    ...
    <textarea
      ...
      class="h-40 text-base leading-none text-gray-50 p-3 focus:outline-none mt-3 sm:mt-4 bg-black border resize-none caret-purple"
    />
  </div>
